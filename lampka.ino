...
#define PIXELS 14  // Number of pixels in the string
...
#define direction OCR0A
#define set_constant_1 DDRB |= (1<<2)
#define set_constant_0 DDRB &= ~(1<<2)
#define constant_eq_1 DDRB & (1<<2)
#define current_hue EEDR
